{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 457.0, 139.0, 902.0, 793.0 ],
		"bglocked" : 0,
		"defrect" : [ 457.0, 139.0, 902.0, 793.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-49",
					"fontname" : "Arial",
					"patching_rect" : [ 61.0, 755.0, 44.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-48",
					"fontname" : "Arial",
					"patching_rect" : [ 790.0, 293.0, 30.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1,
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"id" : "obj-45",
					"fontname" : "Arial",
					"patching_rect" : [ 697.0, 77.0, 30.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1,
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"id" : "obj-36",
					"fontname" : "Arial",
					"patching_rect" : [ 657.0, 78.0, 30.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1,
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"id" : "obj-34",
					"fontname" : "Arial",
					"patching_rect" : [ 126.0, 10.0, 30.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1,
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"id" : "obj-32",
					"patching_rect" : [ 512.0, 284.0, 20.0, 20.0 ],
					"numinlets" : 1,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-31",
					"fontname" : "Arial",
					"patching_rect" : [ 513.0, 358.0, 48.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-30",
					"fontname" : "Arial",
					"patching_rect" : [ 513.0, 318.0, 81.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 4,
					"addpoints" : [ 0.0, 0.133333, 0, 393.617035, 0.6, 0, 989.361694, 0.68, 0, 1457.446777, 0.546667, 0, 2000.0, 0.133333, 0 ]
				}
