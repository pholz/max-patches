{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 24.0, 67.0, 1584.0, 878.0 ],
		"bglocked" : 0,
		"defrect" : [ 24.0, 67.0, 1584.0, 878.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-131",
					"fontname" : "Arial",
					"patching_rect" : [ 991.0, 117.0, 115.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-125",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1141.0, 163.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 663.0, 608.0, 51.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 652.0, 541.0, 61.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-134",
					"fontname" : "Arial",
					"patching_rect" : [ 700.940002, 688.139954, 34.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 655.0, 641.0, 41.0, 32.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"color" : [ 0.317647, 0.709804, 0.321569, 1.0 ],
					"patching_rect" : [ 528.0, 595.0, 81.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 529.0, 565.0, 50.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"color" : [ 0.317647, 0.709804, 0.321569, 1.0 ],
					"patching_rect" : [ 553.0, 718.0, 105.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 534.0, 668.0, 56.0, 18.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 460.0, 588.0, 50.0, 18.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 631.940002, 580.139954, 100.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "OSC-route /obstacle /collect /any /numobjects /objon",
					"numinlets" : 1,
					"numoutlets" : 6,
					"id" : "obj-41",
					"fontname" : "Arial",
					...
					"fontface" : 1,
					"patching_rect" : [ 239.299988, 503.721985, 361.0, 23.0 ],
					"fontsize" : 14.0
				}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"id" : "obj-1",
									"outlettype" : [ "int" ],
									"patching_rect" : [ 73.0, 66.0, 25.0, 25.0 ],
									"comment" : ""
								}
