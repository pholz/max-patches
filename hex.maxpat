{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 896.0, 165.0, 640.0, 480.0 ],
		"bglocked" : 0,
		"defrect" : [ 896.0, 165.0, 640.0, 480.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "open speech01_cut.wav",
					"outlettype" : [ "" ],
					"patching_rect" : [ 244.0, 196.0, 140.0, 18.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 183.0, 28.0, 45.0, 45.0 ],
					"id" : "obj-12",
					"numinlets" : 1,
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"text" : "open",
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.0, 70.0, 37.0, 18.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 131.0, 53.0, 20.0, 20.0 ],
					"id" : "obj-9",
					"numinlets" : 1,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "sfrecord~ 2",
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 155.0, 99.0, 71.0, 20.0 ],
					"id" : "obj-8",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 420.0, 430.0, 137.0, 20.0 ],
					"id" : "obj-84",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 403.0, 206.0, 128.0, 128.0 ],
					"id" : "obj-2",
					"numinlets" : 1,
					"numoutlets" : 4
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 264.0, 136.0, 113.0, 18.0 ],
					"id" : "obj-74",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "loop 1",
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.0, 164.0, 43.0, 18.0 ],
					"id" : "obj-61",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 265.0, 163.0, 121.0, 18.0 ],
					"id" : "obj-60",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 149.0, 161.0, 36.0, 20.0 ],
					"id" : "obj-55",
					"triscale" : 0.9,
					"fontname" : "Arial",
					"numinlets" : 1,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 205.5, 170.0, 187.0, 170.0, 187.0, 157.0, 158.5, 157.0 ]
				}
