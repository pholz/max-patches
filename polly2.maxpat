{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 175.0, 44.0, 1282.0, 897.0 ],
		"bglocked" : 0,
		"defrect" : [ 175.0, 44.0, 1282.0, 897.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "+ 20",
					"fontname" : "Arial",
					"patching_rect" : [ 955.0, 232.0, 34.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-14",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "clear, moveto 20 20",
					"fontname" : "Arial",
					"patching_rect" : [ 512.0, 311.0, 115.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-10",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "moveto 10 500",
					"fontname" : "Arial",
					"patching_rect" : [ 976.0, 345.0, 90.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-8",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "prepend moveto 10",
					"fontname" : "Arial",
					"patching_rect" : [ 937.0, 308.0, 114.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"id" : "obj-7",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "/ 15.",
					"fontname" : "Arial",
					"patching_rect" : [ 776.0, 408.0, 34.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-47",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "pack i i",
					"fontname" : "Arial",
					"patching_rect" : [ 1079.0, 436.0, 48.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-25",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "clear",
					"fontname" : "Arial",
					"patching_rect" : [ 80.0, 190.0, 37.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-13",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "brgb 0 0 100",
					"fontname" : "Arial",
					"patching_rect" : [ 85.0, 161.0, 78.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-12",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "metro 240",
					"fontname" : "Arial",
					"patching_rect" : [ 644.0, 102.0, 65.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-4",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 242.0, 532.0, 640.0, 480.0 ],
					"numinlets" : 1,
					"id" : "obj-3",
					"numoutlets" : 2,
					"outlettype" : [ "", "" ]
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"patching_rect" : [ 243.0, 443.0, 121.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"id" : "obj-1",
					"numoutlets" : 2,
